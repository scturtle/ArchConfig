-- config file for awesome 3.4.11 by scturtle (scturtle@gmail.com)
...
--batwidget.width, batwidget.align = 47, "right"
...
vicious.register(memwidget, vicious.widgets.mem, "<span color=\"yellow\">$1%</span> ($2MB)", 13)
