...
awful.util.spawn_with_shell("/usr/lib/vino/vino-server")
awful.util.spawn_with_shell("thinkhdaps &")
...
vicious.register(batwidget, vicious.widgets.bat, "<span color=\"orange\">$1$2%</span>", 61, "BAT0")
...
cpuwidget.width, cpuwidget.align = 55, "right"
vicious.register(cpuwidget, vicious.widgets.cpu, "<span color=\"green\">$1%:$2%</span>", 2)
...
--cpufreqwidget1.width, cpufreqwidget1.align = 45, "right"
--vicious.register(cpufreqwidget1, vicious.widgets.cpufreq, "$2GHz", 2, "cpu1")
...
for s = 1, screen.count() do
	...
	mywibox[s].widgets = {
		...
		--spacer,cpufreqwidget, spacer, cpufreqwidget1, spacer, --separator,
